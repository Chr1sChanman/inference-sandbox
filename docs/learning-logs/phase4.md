...
In `src/inference_sandbox/bench/ollama_bench.py`, I currently use these fields and definitions:
...
**What I built**  
- `src/inference_sandbox/eval/perplexity.py`: `corpus_perplexity()` with token-weighted NLL.  
